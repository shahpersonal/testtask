...
class xssClean {
    ...
    private function strip_tags( $input ) {
        // Remove tags
        $input = preg_replace('#</*(?:applet|b(?:ase|gsound|link)|embed|frame(?:set)?|i(?:frame|layer)|l(?:ayer|ink)|meta|javascript|RENAME|document.cookie|onmouseover|object|s(?:cript|tyle)|title|xml)[^>]*+>#i', '', $input);
		...
		$remove[] = "%"; // just as another example
		$remove[] = "select"; // just as another example
		$remove[] = "insert"; // just as another example
		$remove[] = "SELECT"; // just as another example
		$remove[] = "UPDATE"; // just as another example
		$remove[] = "TRUNCATE"; // just as another example
		$remove[] = "ALTER"; // just as another example
		$remove[] = "TABLE"; // just as another example
		$remove[] = "DROP"; // just as another example
		$remove[] = "RENAME"; // just as another example
